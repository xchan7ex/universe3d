        ...
        <div className="footer-content">
          <div className="footer-section footer-brand">
            ...
            <div className="footer-socials">
              <a href="https://www.instagram.com/_explorex._?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className="social-link" title="Instagram" aria-label="Instagram">
              ...
              <a href="https://github.com/Hirusha-Pramuditha/Universe3D.git" className="social-link" title="GitHub" aria-label="GitHub">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
