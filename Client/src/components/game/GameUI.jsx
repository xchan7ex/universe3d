...
function GameUI({ playerNickname, selectedBuilding, onBackToMenu, onTeleport, currentFloor, setCurrentFloor, missions, onMissionUpdate, playerRef }) {
  ...
  // floorLabel & minimapImage removed — floor image is handled by MINIMAP_CONFIG in the canvas RAF loop
